...
Note: 1)Please change the root path to your own local path to successfully load functions under folders "Simulation_Extension_Functions" and.   "Simulation_Steps_Functions"
      2) If you want to run the overall simulation code, please run 'Simulation_Overall_Rundata.R'.  Since our simulation code includes all the comparisons, it would be a little bit time-consuming. 
