...
Get_Residual_mat_for_GTEx_Network <- function(trait,tissue_type,q_thres){
  ...
  Genes_file_prefix = "/exeh_3/yinly/BayesianNetwork/02_GTex_Network/01_Single_Tissue/Exploratory_Analysis/GTEx_All_Selected_Genes_CIS_Trans_Update/"
  ...
  resid_mat_selected_prefix = "/exeh_3/yinly/BayesianNetwork/02_GTex_Network/01_Single_Tissue/Exploratory_Analysis/Residmat_All_Update/"
...
#index = c(1,5,11,12,15,21,22,27,29,32,41)
# Remove Cov19, include Cov19_Confirm and Cov19_Severe
#index = c(1,5,11,12,21,22,28,31,40,45,55,56)
index <- c(16,17)
