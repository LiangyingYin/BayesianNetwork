...
# Description: update the pMax matrix derived from pc_obj accordingly.
# When apply stable.fast for the pc algorithm, the pMax matrix is only upper-triangular updated 
# while estimating the skeleton. In this regard, we could update the pMax matrix accordingly 
...
#for(j in 1:length(index)){
 ...
 cat("The bootstrapped pc algorithm for the",i,"trait",file_name,"is completed! \n")
}
