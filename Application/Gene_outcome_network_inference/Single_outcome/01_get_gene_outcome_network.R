...
setwd("/exeh_3/yinly/BayesianNetwork/03_UKBB_Network/Binary_Rerun/")
get_Causal_Network_Based_On_UKBB <- function(target_outcome_name,outcome_index,outcome_name,p_thres){
  ...
  #expression_file_dir = "/exeh_3/yinly/BayesianNetwork/01_PrediXican/Result/Filtered/UKBB_Adipose_Subcutaneous_predicted_expression.txt"
  #pheno_dir = "/exeh_3/yinly/BayesianNetwork/03_UKBB_Network/01_Single_Trait/Data/UKBB_Extracted_Traits_30April.txt"
  # Revised by yinly, Mar 31, 2022
  # Updated data for covid
  ...
  # Revised by yinly, April 21, 2021
  # Description: for breast and prostate cancer, those NAs could be regarded as controls
  outcome[which(is.na(outcome[,2])),2] = 0
  ...
  # Description: rankNorm may change the distribution of data, so we remove this for binary traits
  ...
  #****************************************************************************************************************************
  # Revised by yinly, June 4, 2021
  # Description: remove rankNorm, since this maybe change the distribution of the data, so we directly set it to original data
  #****************************************************************************************************************************
  ...
  proc.time()-t1
  filepath = paste0("UKBB_",outcome_name,"_Whole_Blood.Rdata")
